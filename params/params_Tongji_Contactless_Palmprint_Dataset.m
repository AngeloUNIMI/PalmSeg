...
param.segm.colorSpaceTrans = 'rgb2hsv';
param.segm.th_em = 0.85; %segmentation effectiveness threshold
param.segm.thSegmRed = -0.10; %reduction factor for binarization threshold (pos. values = harder threshold)
param.segm.numCCbinar = 30; %num of cc after which binarization is messy
param.segm.thVessModVe = 0.07; %-0.03 %threshold add factor for vertical edges (pos. values = harder threshold)
param.segm.thVessModHo = 0.07; %threshold add factor for horizontal edges (pos. values = harder threshold)
param.segm.indKirschVer = [1 2]; %[1 2 3 4 7 8]
param.segm.indKirschHor = [5 6]; %[5 6 3 4 7 8]
param.segm.edgeVeSearchAngle = 2;
param.segm.edgeHoSearchAngle = 2;
param.segm.useEdgeAdd = 0;
param.segm.subEdgesVer = 0; %subtract vertical edges
param.segm.useRefl = 0; %add reflections / horizontal edges
...
param.rejectPoints.minDistanceBorder = 50;
