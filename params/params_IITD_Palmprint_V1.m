...
param.segm.th_em = 0.90; %segmentation effectiveness threshold
param.segm.thSegmRed = -0.00; %reduction factor for binarization threshold (pos. values = harder threshold)
param.segm.numCCbinar = 1; %num of cc after which binarization is messy
param.segm.thVessModVe = 0.03; %%threshold add factor for vertical edges (pos. values = harder threshold)
param.segm.thVessModHo = 0.0; %threshold add factor for horizontal edges (pos. values = harder threshold)
param.segm.indKirschVer = [1 2]; %[1 2 3 4 7 8]
param.segm.indKirschHor = [5 6]; %[5 6 3 4 7 8]
param.segm.edgeVeSearchAngle = 2; %5
...
param.segm.fGauss_size = [15 15]; %[5 5]
param.segm.fGauss_sigma = 3; %2
param.segm.typeStrel = 'disk';
param.segm.sizeStrel_small = 1;
param.segm.sizeStrel_medium = 3;
param.segm.sizeStrel_large = 10;
param.segm.typeStrelEdge = 'line';
param.segm.sizeStrelEdge_small = 1;
param.segm.sizeStrelEdge_medium = 5;
param.segm.sizeStrelEdge_large = 10;
param.segm.sizeStrelEdge_huge = 15; %30
...
param.localsearch.beta = 10;
param.localsearch.alpha = 10;
param.localsearch.mu = 10;
